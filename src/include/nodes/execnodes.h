...
typedef struct WindowAggState
{
	...
	//start->add by mjs
	int64		gap;		/* the gap between frameheadpos and TTV's head position */
	int64		framesize;	/* current frame size */
	//int64		framesize1;	/* current frame size */
	int			num_gap;
	int			num_tem;
	...
	//start->add by mjs
	int64		Temheadpos;	/* current TTV's head position */
	int64		Temtailpos;	/* current TTV's tail position */
	//end->add by mjs
	//start->add by mjs
	int			opt_tempTransValue_num;
	int			opt_active_tempTransValue;
	int			opt_ttv_level; //2013, for hierarchy
